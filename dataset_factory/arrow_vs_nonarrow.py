...
class Arrow_vs_NonArrows(DataMeta):
	...
	def __init__(self, **kwargs):
		...
		print(kwargs)
		self.arrow_obj = Arrows(image_height=kwargs['image_height'],
								image_width=kwargs['image_width'],
								padding=kwargs['padding'],
								tri_height_ratio=kwargs['tri_height_ratio'],
								tri_rect_gap=kwargs['tri_rect_gap'],
								min_arrow_len=kwargs['min_arrow_len'],
								rect_thickness=kwargs['rect_thickness'])

		self.nonarrow_obj = NonArrows(image_height=kwargs['image_width'],
									  image_width=kwargs['image_width'],
									  min_tri_len=kwargs['min_tri_len'],
									  max_tri_len=kwargs['max_tri_len'],
									  min_angle=kwargs['min_angle'],
									  max_angle=kwargs['max_angle'],
									  padding=kwargs['padding'],
									  tri_height_ratio=kwargs['tri_height_ratio'],
									  min_rect_length=kwargs['min_rect_length'],
									  max_rect_length=kwargs['max_rect_length'],
									  rect_thickness=kwargs['rect_thickness'])
